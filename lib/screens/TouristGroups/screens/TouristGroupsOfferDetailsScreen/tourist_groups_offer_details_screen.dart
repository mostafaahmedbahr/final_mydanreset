...
class TouristGroupsOfferDetailsScreen extends StatefulWidget {
  const TouristGroupsOfferDetailsScreen({Key? key}) : super(key: key);

  @override
  State<TouristGroupsOfferDetailsScreen> createState() => _TouristGroupsOfferDetailsScreenState();
}

class _TouristGroupsOfferDetailsScreenState extends State<TouristGroupsOfferDetailsScreen> {
  List imagesSlider = [
